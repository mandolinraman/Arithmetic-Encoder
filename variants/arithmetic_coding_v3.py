...
class ArithmeticCoder:
    ...
    def increment(self):
        n = len(self.code_output) - 1
        while self.code_output[n] == 1:
            self.code_output[n] = 0
            n -= 1
        self.code_output[n] = 1
        ...
        #         self.runs[-1] = (np + 1, bp)
        #     else:
        #         self.runs.append((n - 1, 0))
        #         self.runs.append((1, 1))
        # else:
        #     self.increment()
        #     self.runs.append((n, 0))

    def output_bit(self, bit):
        self.code_output.append(bit)

        # if len(self.runs) == 0:
        #     self.runs.append((1, bit))
        # else:
        #     n, b = self.runs[-1]
        #     if b == bit:
        #         self.runs[-1] = (n + 1, b)
    ...
    def encode(self, message):
        ...
        for j, sym in enumerate(message):
            ...
            # print("".join(str(x) for x in self.code_output))
        ...
        # for n, b in self.runs:
        #     self.code_output += n * [b]
